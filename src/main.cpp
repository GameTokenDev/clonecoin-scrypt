...
uint256 hashGenesisBlock("0x10006a92af9d720b77d754ca0554127d32b51528124a2596ae27c08016108644");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 280) // no block reward within the first 280 Blocks
        nSubsidy = 0;
...
static const int64 nTargetTimespan = 0.35 * 24 * 60 * 60; // CloneCoin: 0.35 days
static const int64 nTargetSpacing = 60; // CloneCoin: 60 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal clonecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CloneCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x10006a92af9d720b77d754ca0554127d32b51528124a2596ae27c08016108644");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "CNN, ABC, CBS and NBC all refuse to run fake news Trump ad";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
